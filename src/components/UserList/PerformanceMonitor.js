...
const PerformanceMonitor = ({ totalItems, visibleItems }) => (_jsxs("div", { style: { padding: '8px', fontSize: 13, color: '#6b7280', textAlign: 'right' }, children: ["Showing ", visibleItems, " of ", totalItems.toLocaleString(), " users"] }));
