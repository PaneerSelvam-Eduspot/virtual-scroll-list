...
const PerformanceMonitor: React.FC<PerformanceMonitorProps> = ({ totalItems, visibleItems }) => (
  <div style={{ padding: '8px', fontSize: 13, color: '#6b7280', textAlign: 'right' }}>
    Showing {visibleItems} of {totalItems.toLocaleString()} users
  </div>
);
